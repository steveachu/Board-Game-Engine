...
const int FLIP_VALUE = 2;
const int INITIAL_PIECE = 3;
const int INITIAL_PIECE2 = 4;
const int MAX_PASS_COUNT = 2;
...
private:
   ...
   // Note: This inherits mNextPlayer, mValue, and mHistory from GameBoard.
